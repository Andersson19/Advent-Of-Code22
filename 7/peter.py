...
sizes = list(map(lambda x: x[1], result))
names = list(map(lambda x: x[0], result))
print(f"dirs with size < 100000: {sizes}")
print(f"names with size < 100000: {names}")
print(f"sum of dirs with size < 100000: {sum(sizes)}")
